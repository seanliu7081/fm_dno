...
| **Stage-2 entry config** | [oat/config/train_oatpolicy.yaml](oat/oat/config/train_oatpolicy.yaml) | [oat/config/train_past2next.yaml](oat/oat/config/train_past2next.yaml) |
| **Policy class** | `OATPolicy` ([oat/policy/oatpolicy.py](oat/oat/policy/oatpolicy.py)) | `Past2NextPolicy` ([oat/policy/past2next.py](oat/oat/policy/past2next.py)) |
...
Ours ([oat/policy/past2next.py](oat/oat/policy/past2next.py)):
...
The docstring on `Past2NextPolicy` makes the design intent explicit:
...
| Policy-only | `OATTok` | `Past2NextPolicy` | isolates enriched-past effect |
| Ours (full) | `OATTokSO3Aug` | `Past2NextPolicy` | combined |
