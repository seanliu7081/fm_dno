...
| Doc | Contents |
|---|---|
| [PAST2NEXT.md](PAST2NEXT.md) | End-to-end architecture of the main method (`train_oattok_so3aug` + `train_past2next`) |
...
| `train_past2next` | `Past2NextPolicy` | 16 / 8, `past_n=7` | yes (`OATTok`) |
...
> and `train_past2next`), while most other tokenizers default to 32 (pairing with
